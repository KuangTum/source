...
#SBATCH --ntasks-per-node=2           # 每个节点的任务数量
...
mpirun -np $SLURM_NTASKS /projects/sipv/xkuang/softwares/ompi_openmx/openmx3.9/source/openmx Cubulk.dat -nt $OMP_NUM_THREADS > openmx_olp.std
